...
export default function QuestionPage() {
    ...
    return (
        <div>
            ...
            <main className=" align-middle justify-items-center">
                <div className="flex-col w-full h-screen">
                    <div>
                        <button className=" bg-slate-500 hover:bg-slate-400 disabled:bg-slate-300 text-white rounded-lg p-3 m-1 animate-bounce mt-4" onClick={copyToClipboard}>Share</button>
